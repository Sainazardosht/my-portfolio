...
function About(){
    return(
        ...
        <div className="p-12 py-25 text-center bg-stone-100 text-stone-600 md:w-200">
            ...
            I am organized and resourceful, skilled at optimizing available resources to deliver efficient and impactful web solutions. With a passion for leveraging engineering knowledge and problem-solving skills, I strive to contribute to innovative technology solutions. I thrive in fostering positive team dynamics and problem-solving, contributing to team synergy while embracing opportunities to learn and grow in a fast-paced, technology-driven environment.</p>
        </div>
        </div>
    )
}
